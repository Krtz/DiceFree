...
## 2026-09-25 — Progression identity

**Decision:** Characters start as Novice and use a Twilight's Eve-inspired branching advancement structure. Current working scale begins with four first-tier classes and doubles on later tiers: 4 → 8 → 16 → 32 → 64.

**Note:** Exact class count and advancement cadence remain designable; the architecture should support the model without requiring every class at initial release.
